    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative bg-[#2C221B] text-[#FAFAFA] overflow-hidden min-h-screen flex items-center">
        ...
        <div className="relative w-full max-w-7xl mx-auto px-6 lg:px-12 py-24 lg:py-28 flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            >
              <p>Ne laissez aucun souvenir s'effacer. Créez un espace intime pour rassembler sa vie, ses mots et sa voix, avec ceux qui l'ont connu.</p>
            </div>
      ...
      <section className="bg-muted py-24 lg:py-32">
        <div className="container mx-auto px-6">
          ...
          {/* Gallery */}
          <Reveal>
            <div className="mt-16 lg:mt-24 overflow-hidden rounded-2xl bg-background h-[260px] sm:h-[420px] md:h-auto">", "old_content": "            <div className="mt-16 lg:mt-24 overflow-hidden rounded-2xl bg-background h-[420px] sm:h-[520px] md:h-auto">}
              <img
                src={steleMains}
